...
function mapSummaryToVerdict(summary: SummaryResponse): VerdictResult {
  ...
  return {
    ...
    protection_guidance: summary.protection_guidance,
    affected_apis: summary.affected_apis,
    top_signals: summary.top_signals,
    delivery_status: summary.delivery_status,
    delivery_hold_reason: summary.delivery_hold_reason,
    external_delivery_ready: summary.external_delivery_ready,
    agent_ready: summary.agent_ready,
